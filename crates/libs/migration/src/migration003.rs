...
impl MigrationTrait for Migration {
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .if_not_exists()
                    .col(
                        ColumnDef::new(tag_entity::Column::Id)
                            .uuid()
                            .not_null()
                            .primary_key(),
                    )
                    ...
                    .col(
                        ColumnDef::new(tag_entity::Column::EntityId)
                            .uuid()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(tag_entity::Column::EntityType)
                            .string()
                            .not_null(),
                    )
                    .to_owned(),
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .if_not_exists()
                    .col(
                        ColumnDef::new(attachment::Column::Id)
                            .integer()
                            .not_null()
                            .primary_key()
                            .auto_increment(),
                    ...
                    .col(
                        ColumnDef::new(attachment::Column::Category)
                            .string()
                            .not_null(),
                    )
    ...
    async fn down(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        manager
            .drop_table(Table::drop().table(attachment::Entity).to_owned())
            .await?;
        Ok(())
    }
}
